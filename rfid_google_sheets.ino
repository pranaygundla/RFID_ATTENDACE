...
const String sheet_url = "https://script.google.com/macros/s/AKfycbyMzBVSTAkoiYudGUXNEkt0Xv0tGLhC-SgdAXyIbL_9_fVlv64nbnRgz6ugU61TDN5a/exec?name=";  // Enter Google Script URL
...
//-----------------------------------------
#define WIFI_SSID "POCO M6 Pro 5G"  // Enter WiFi Name
#define WIFI_PASSWORD "2444666666"  // Enter WiFi Password
//-----------------------------------------
